...
try:
 ...
 for Device in DeviceList:   	# if any device is connected
  ...
  if exists:
   ...
   '''
   OphirCOM.ModifyWavelength(DeviceHandle, 0, 0, 415)
   OphirCOM.ModifyWavelength(DeviceHandle, 0, 1, 470)
   OphirCOM.ModifyWavelength(DeviceHandle, 0, 2, 530)
   OphirCOM.ModifyWavelength(DeviceHandle, 0, 3, 620)
   OphirCOM.ModifyWavelength(DeviceHandle, 0, 4, 850)

   OphirCOM.SetWavelength(DeviceHandle, 0, 0)
   sleep(1)
   OphirCOM.SetWavelength(DeviceHandle, 0, 1)
   sleep(1)
   OphirCOM.SetWavelength(DeviceHandle, 0, 2)
   sleep(1)
   OphirCOM.SetWavelength(DeviceHandle, 0, 3)
